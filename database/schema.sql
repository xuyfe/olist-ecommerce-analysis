...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/6CcJDC
...
-- ALTER TABLE "geo_locations" ADD CONSTRAINT "fk_geo_locations_order_id_order_item_id" FOREIGN KEY("order_id", "order_item_id")
...
-- ALTER TABLE "product_categories" ADD CONSTRAINT "fk_product_categories_product_category_name" FOREIGN KEY("product_category_name")
